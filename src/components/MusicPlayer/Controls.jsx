...
const Controls = ({ isPlaying, repeat, setRepeat, shuffle, setShuffle, currentSongs, handlePlayPause, handlePrevSong, handleNextSong }) => (
  <div className="flex items-center justify-around md:w-36 lg:w-50 xl:w-80">
    ...
    {isPlaying ? (
      <BsFillPauseFill size={35} color="#FFF" onClick={handlePlayPause} className="cursor-pointer" />
    ) : (
